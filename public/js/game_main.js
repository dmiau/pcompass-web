...
function nextQuestion() {
  ...
  if (numQuestion >= 0)
  {
    ...
    console.log('loc' + contents[numQuestion][0][0])
    console.log('loc' + contents[numQuestion][0][0].lat + ' ' + contents[numQuestion][0][0].lng)
    ...
    console.log('zoom' + contents[numQuestion][0][1])
